...
registerApplication({
  name: "portal-angular-container",
  app: () => System.import("portal-angular-container"),
  activeWhen: ["/portal"],
});

registerApplication({
  name: "portal-angular-customer",
  app: () => System.import("portal-angular-customer"),
  activeWhen: (location) =>
    location.pathname.startsWith("/portal/angular-customer"),
});

registerApplication({
  name: "portal-angular-advisor",
  app: () => System.import("portal-angular-advisor"),
  activeWhen: (location) =>
    location.pathname.startsWith("/portal/angular-advisor"),
});
